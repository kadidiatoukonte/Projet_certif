...
<header class="w3-display-container w3-content w3-hide-small" style="max-width:1500px">
  ...
  <div class="w3-display-middle" style="width:65%">
    <div class="w3-bar w3-transparent" style="color: floralwhite;">
      ...
      <p><a href="index.php">ACCUEIL</a> / DESTINATIONS / Afrique du Sud</p>
    </div>
  </div>  
</header>
...
<div class="row col-10 mx-auto p-0 mt-4 card-deck">
  <div class="col">
      <p class="brown sous_titre" style="text-align: center;"><strong>La belle Afrique du Sud est devenue la première destination touristique en Afrique et l’essor ne cesse de croître …</strong><br></p>
  </div>
    ...
    <tr class="col-12">
            ...
            <div class="col-12">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img class="d-block w-100" src="../assets/img/as2.jpg" alt="First slide" width="800" height="400">
                  </div>
                  <div class="carousel-item">
                    <img class="d-block w-100" src="../assets/img/as3.jpg" alt="Second slide" width="800" height="400">
                  </div>
                  <div class="carousel-item">
                    <img class="d-block w-100" src="../assets/img/as4.jpg" alt="Third slide" width="800" height="400">
                  </div>
                  <div class="carousel-item">
                    <img class="d-block w-100" src="../assets/img/as5.jpg" alt="Third slide" width="800" height="400">
                  </div>
                  <div class="carousel-item">
                    <img class="d-block w-100" src="../assets/img/as6.jpg" alt="Third slide" width="800" height="400">
                  </div>
                  <div class="carousel-item">
                    <img class="d-block w-100" src="../assets/img/as7.jpg" alt="Third slide" width="800" height="400">
                  </div>
                  <div class="carousel-item">
                    <img class="d-block w-100" src="../assets/img/as8.jpg" alt="Third slide" width="800" height="400">
                  </div>
                </div>
              </div>
            </div>
      ...
      <td class="col-12" id="lekenya">
          <div class="col-10 mx-auto"> 
            <p><em><strong>Carte d’identité de l’Afrique du Sud :</strong></em></p>
      ...
      <td class="col-12" id="formalites">
            <div class="col-10 mx-auto">     
              <h3><strong>Formalités d’entrée en Afrique du Sud :</strong></h3>
              ...
              <ol>
                ...
                Le livret de famille pourra également être présenté pour justifier des filiations.</li>
                ...
                Le jugement de divorce ou tout autre document officiel attestant de l’attribution de la garde de l’enfant traduit par un traducteur assermenté.</li>
                ...
                Les coordonnées complètes des parents.</li>
              </ol>
            </div>
      </td>
      <td class="col-12" id="sante">
            <div class="col-10 mx-auto">      
              ...
              <ul>
                ...
                <li>Souscrire une assurance-voyage (frais médicaux et rapatriement sanitaire). Pour les contrats d’assurance-voyage associés à une
                   carte de crédit ou une mutuelle, pensez à vous munir du numéro de téléphone d’urgence de la compagnie d’assistance.<br>
      ...
      <td class="col-12" id="video">
            <div class="col-10 text-center mx-auto">
              <iframe width="560" height="315" src="https://www.youtube.com/embed/mm3U-vnzwR4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
      </td>
    </tr>
  </tbody>
...
<div class="col-10 mx-auto mt-4">
  ...
  <ul>
    <li><a href="#" target="_blank">Les safaris en Afrique du Sud</a></li>
    <li><a href="#" target="_blank">Les hôtels et lodges en Afrique du Sud</a></li>
    <li><a href="#" target="_blank">Lune de miel au Cap</a></li>
  </ul>
